...
//C C++
int LANG_CV[256]={3,4,5,33,45,85,122,192,197,248,0};
//pascal
int LANG_PV[256] = {3,4,54,85,174,191,248,0};
//java
int LANG_JV[256] = {0,2,3,5,6,19,33,45,82,85,91,120,122,125,174,175,191,192,195,197,240,248,0};
//ruby
int LANG_RV[256] = {0,0};
//bash
int LANG_BV[256] = {0,0};
