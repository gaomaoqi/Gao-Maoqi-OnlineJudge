...
cd /home/judge/
svn co  https://github.com/zhblue/hustoj/branches/php7/trunk  src
apt-get install -y make flex g++ clang libmysqlclient-dev libmysql++-dev php-fpm nginx mysql-server php-mysql php-gd fp-compiler openjdk-8-jdk php-mbstring php-xml
